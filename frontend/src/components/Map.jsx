      ...
      if (includeLinearFeatures && linearFeatures && linearFeatures.length > 0) {
        linearFeatures.forEach(feature => {
          ...
          if (search) {
            ...
            isLayerVisible = showTrails && trailPassesActivityFilter(feature, visibleTypes, iconConfig);
      ...
      >
        ...
        {linearFeatures && linearFeatures.map(feature => {
          ...
          const isVisible = searchQuery
            ...
            : ((feature.poi_roles?.includes('trail') && showTrails && trailPassesActivityFilter(feature, visibleTypes, iconConfig)) ||
